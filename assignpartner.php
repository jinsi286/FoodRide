    ...
    if(isset($_GET['order_id']))
{
    ...
    if((isset($_GET['assignpart'])) && (isset($_GET['del_id'])))
    {
    $order_id = $_GET['order_id'];
    $assignpart = $_GET['assignpart'];
    $del_id = $_GET['del_id'];
    echo $qry = "update orders set assigned = 1,del_id = $del_id where order_id = $order_id";
    $res = mysqli_query($con,$qry);
    echo $dqry = "update delpartner set assigned = 1,order_id = $order_id where del_id = $del_id";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                            $qry = "select * from delpartner where assigned = 0";
                                            $res = mysqli_query($con,$qry);
                                            while ($row = mysqli_fetch_row($res)) 
                                            {
                                               ...
                                               echo "<td>$row[5]</td>";
                                               echo "<td>$row[6]</td>";
                                               echo "<td><a href='assignpartner.php?assignpart=1&del_id=$row[0]&order_id=$order_id'>Assign</a></td>";
                                            }
