...
if(isset($_GET["cat_id"]))
{
    ...
    $cat_id = $_GET["cat_id"];
    $sqry = "select * from items where res_id = $res_id && cat_id = $cat_id";
    $sres = mysqli_query($con,$sqry);
    $cqry = "select cat_name from category where cat_id = $cat_id";
            ...
            <div class="inner" style="min-height:1200px;padding-top:20px;">
                ...
                <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><?php $crow = mysqli_fetch_row($cres);echo $crow[0];?></h2>
                        </div>
