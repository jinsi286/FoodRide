            ...
            <div class="inner" style="min-height:1200px;">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <br><br>
                        <h2 align="center">Delivery Partner Registration</h2>
                        <br><br><br>
                ...
                <div class="form-group">
                        <label class="control-label col-lg-4">Profile Image</label>
                        <div class="col-lg-8">
                    ...
                    <div style="text-align:center" class="form-actions no-margin-bottom">
                        <input type="submit" value = "Register" name = "insert" id = "insert" class="btn btn-primary btn-lg " />
                    </div>
                    <div style="text-align:center" class="form-actions no-margin-bottom">
                ...
                if($con)
                    {
                        if(isset($_POST["insert"]))
                        {
                            ...
                            $folder = "DeliveryImages/".$filename;
                            ...
                            echo $qry = "insert into delpartner(name,address,image,email,mobile,password,assigned) values ('$name','$address','$image','$email','$mobile','$password',0)";
