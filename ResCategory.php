...
$sqry = "select distinct cat_id from items where res_id = $res_id";
...
<div class="row">
                ...
                // echo "<div class = 'col-lg-12'";
                    while($row = mysqli_fetch_row($sres))
                    {
                        ...
                        echo "<a id='img' href='ResMenu.php?cat_id=$crow[0]' title=''><img src=$crow[2] alt=$crow[1] height='250px' width='250px' style='padding: 15px;'/><figcaption>$crow[1]</figcaption></a>";
                        echo "</div>";
                    }
                    // echo "</div>";
                ?>
