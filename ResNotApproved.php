...
if(isset($_GET["id"]))
    {
        $res_id = $_GET["id"];
        $qry = "update admin set approved = 1 where res_id = $res_id";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                            $qry = "select res_id from admin where approved = 0";
                                            $res = mysqli_query($con,$qry);
                                            while($frow = mysqli_fetch_row($res))
                                            {
                                                ...
                                                while($row = mysqli_fetch_row($sres))
                                                {
                                                    ...
                                                    echo "<td>$row[6]</td>";
                                                    echo "<td>$row[7]</td>";
                                                    echo "<td><a href='ResNotApproved.php?id=$row[0]' class='btn btn-primary'>Approve</a></td>";
                                                    echo "</tr>";
                                                }
                                            }
