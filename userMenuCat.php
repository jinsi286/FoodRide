...
<nav class="sidebar">
    ...
    <?php
    echo "<a href='userMenu.php?res_id=$res_id'><h2><b style='color: black'>Menu</b></h2></a>";
    ?>
   <br>
    <ul>
...
<section class="brd">
    ...
    <div class="box-bread">
        ...
        <?php
            $mqry = "select * from items where res_id = $res_id && cat_id = $cat_id";
            ...
            while($mrow = mysqli_fetch_row($mres))
            {
                ...
                echo "<br>";
                echo "<a href='cart.php' class='btn' name='addtocart'>Add to cart</a>";
                if(isset("addtocart"))
                {
                    $_SESSION["res_id"] = $res_id;
                    $_SESSION["item_id"] = $mrow[0];
